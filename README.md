...
1. Now we assume the role of a merchant who has onboarded with us. Import this account `${PRIVATE_KEY}` into metamask. This is the whitelisted account of the sample UEN `198402065R` you paid to.
1. Import SGDk `0xa462f79a8c09a0770614140B9f53Ebc9fD8413b5` and SGDm `0x1F11B837513dF2F3e17D5b017f83C5c17C76261f`.
